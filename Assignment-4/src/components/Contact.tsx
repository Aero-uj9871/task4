...
// import y from '../assets/Group_3038.png'
        ...
        <div className="md:relative items-center  md:px-20 lg:px-30 xl:px-42 py-20" >
            <div className="contact-container flex flex-col md:flex-row items-center justify-center gap-30 sm:p-10  md:pt-0 pt-10 bg-[#e2eaff] md:relative">
                <div className="contact-details md:absolute  bg-white shadow-xl   md:w-[45%] md:h-[65%]
                    ...
                    <div className="p-10">
                        <h3 className=" font-kanit sm:text-[24px] text-[24px] text-[#002856] font-medium mb-4 text-left">Contact Details</h3>
                        <div className=" space-y-5 md:py-4">
                            <div className="flex flex-row justify-baseline space-x-3 items-start">
                                ...
                                <p className=" text-[#4b4b6d] text-left  font-mulish sm:text-[24px] text-[24px]  ">1187 Lake Forest City,<br /> Uttarakhand, 110006, India</p>
                            </div>

                            <div className="flex flex-row space-x-3">
                                <img src={mail}></img>
                                <p className="text-[#4b4b6d] text-left font-mulish sm:text-[24px] text-[24px]"> support@villacrest.in</p>
                            </div>

                            <div className="flex flex-row space-x-3">
                                <img src={mobile}></img>
                                <p className="text-[#4b4b6d] text-left font-mulish sm:text-[24px] text-[24px]"> +91-9910014421, 9891149697</p>
                            </div>
