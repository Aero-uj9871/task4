                ...
                <div className='bg-[#eaf0ff] rounded-lg w-full sm:w-[80%] mx-auto'>
                    <div className='md:py-10 py-5'>
                        ...
                        <div className='md:px-20  mt-3 px-2'>
                            ...
                            <p className='font-navabarLinks text-center lg:text-[22px] md:text-xl  sm:text-lg text-base text-[#737b7d]  md:mt-5 lg;mt-7 sm:mt-4 mt-2'>Shitlakhet is known for its natural beauty. Nestled in the lap of nature, this hill station attracts tourists. Shitlakhet is a small hill station. But it is very calm and pleasant. Here you can see the beautiful peaks of the Himalayas.</p>
                        </div>
                    </div>
                </div>
            </section>
