...
function Navbar() {
  return (
    <nav className="bg-[#3c64b1]/20 shadow-sm p-4 flex items-center justify-between sm:justify-around gap-12 overflow-x-hidden">
      <div className=""><img src={logo} alt="" className="h-10 w-auto sm:{h-120 w-2xl} md:w-120" /></div>
      ...
      <ul className="hidden sm:flex text-nowrap justify-around space-x-6 text-md md:{space-x-6 text-3xl} items-center  sm:{w-120 mr-4}">
        ...
        <li><Link to="/contact" className="bg-primary font-navabarLinks text-white px-4 py-2 rounded hover:bg-blue-700">Contact</Link></li>
      </ul>
    </nav>
  );
}
