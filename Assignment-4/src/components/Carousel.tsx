...
const Carousel = () => {
    ...
    return (
        <div className="relative mx-auto mt-16 px-30 mb-2 pb-4">
            ...
            {/* Navigation Buttons */}
            <button
                className="absolute top-1/2 left-32 transform -translate-y-1/2 z-30 p-2  hover:bg-gray-800/80 rounded-full transition-all"
                onClick={prevSlide}
            >
            ...
            <button
                className="absolute top-1/2 right-32 transform -translate-y-1/2 z-30 p-2  hover:bg-gray-800/80 rounded-full transition-all"
                onClick={nextSlide}
            >
                <svg className="w-6 h-6 text-white" viewBox="0 0 6 10" fill="none" xmlns="http://www.w3.org/2000/svg">
